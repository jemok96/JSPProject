...
<body>
	...
	<header class="header">
		...
		<div class="header__column">
			<span class="header__welcome"><span id="guest"> ${(empty userId)?"손님":userId}</span>안녕하세요!</span> <a
			...
			<div class="sector">
				<div class="sector__wrapper">
					<div class="sector__column">
						...
						<div class="sector__text">우리 아파트 단지의 위치를 확인 하실 수 있습니다.</div>
					</div>
					<div class="sector__column">
						<div class="sector__img">
						...
						<div class="divider"></div>
						<div class="sector__text">우리 아파트의 중요 공지사항을 확인 하실 수 있습니다.</div>
					</div>
					<div class="sector__column">
						<div class="sector__img">
							<a href="/board"><i
						...
						<div class="divider"></div>
						<div class="sector__text">우리 아파트 주민들과 자유롭게 소통해 보세요</div>
					</div>
				</div>
			</div>
			<div class="sector__wrapper">
				<div class="sector__column">
					...
					<div class="divider"></div>
					<div class="sector__text">오늘의 날씨 확인하세요</div>
				</div>
				<div class="sector__column">
					<div class="sector__img">
				...
				<div class="sector__column">
					...
					<div class="divider"></div>
					<div class="sector__text">우리 아파트 주민들과 물건을 나누어 보세요</div>
				</div>
			</div>
		</div>
		</content>
