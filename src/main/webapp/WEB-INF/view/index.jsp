...
<html lang="ko">
  ...
  <body>
    <header class="header">
      ...
      <div class="header__column">
        <span class="header__welcome"><strong>손님</strong> 안녕하세요!</span>
        <a href=""><button class="header__btn">회원가입</button></a>
        <a href=""><button class="header__btn">로그인 페이지로 이동</button></a>
      </div>
    </header>
    <main class="main">
      <nav class="main__nav">
            ...
            <div class="sector__wrapper">
              <div class="sector__column">
                <div class="sector__img">
                  <a href=""
                    ><i class="fa-solid fa-location-dot fa-4x white--i"></i
                  ></a>
                </div>
                <div class="sector__title">단지 위치</div>
                <div class="sector_text">
                  우리 아파트 단지의 위치를 확인 하실 수 있습니다.
                </div>
              </div>
              <div class="sector__column">
                <div class="sector__img">
                  <a href="">
                    <i class="fa-regular fa-bell fa-4x white--i"></i
                  ></a>
                </div>
                <div class="sector__title">공지 사항</div>
                <div class="sector_text">
                  우리 아파트의 중요 공지사항을 확인 하실 수 있습니다.
                </div>
              </div>
              <div class="sector__column">
                <div class="sector__img">
                  <a href=""
                    ><i class="fa-solid fa-comments fa-4x white--i"></i
                  ></a>
                </div>
                <div class="sector__title">입주자 자유게시판</div>
                <div class="sector_text">
                  우리 아파트 주민들과 자유롭게 소통해 보세요
                </div>
              </div>
            </div>
          </div>
